                                    ...
                                    <div class="card-body">
                                        <form action="<?php echo base_url(); ?>pegawai/tambah" method="post" enctype="multipart/form-data">
                                            <div class="form-group">
                                                <label for="inputText3" class="col-form-label">Upload Foto Mobil</label> <br>
                                                max 100kb. allow gif,jpg,png
                                                <input type="file" name="berkas" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label for="inputText3" class="col-form-label">Nama Mobil</label>
                                                <input id="inputText3" type="text" name="nama_mobil" class="form-control" placeholder="Taruna">
                                            </div>
                                           <div class="form-group">
                                                <label for="inputText5" class="col-form-label">Nomor Polisi</label>
                                                <input id="inputText5" type="text" name="nopol" class="form-control" placeholder="N 1678 SU">
                                            </div>
                                            <div class="form-group">
                                                <label for="inputText4" class="col-form-label">Warna</label>
                                                <input id="inputText4" type="text" name="warna" class="form-control" placeholder="Silver">
                                            </div>
                                            <div class="form-group">
                                                <label for="inputPassword">Jumlah Kursi</label>
                                                <input id="inputPassword" type="number" placeholder="7" name="jumlah_kursi" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label for="inputPassword">Tahun</label>
                                                <input id="inputPassword" type="number" placeholder="2021" name="tahun" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label for="inputPassword">Merk</label>
                                                <input id="inputPassword" type="text" placeholder="Daihatsu" name="merk" class="form-control">
                                            </div>
                                            <div class="form-group">
