                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form action="<?php echo base_url(); ?>pegawai/t_penyewa" method="post" enctype="multipart/form-data">
                                            <div class="form-group">
                                                <label for="inputText3" class="col-form-label">Upload Foto KTP</label> <br>
                                                max 100kb. allow gif,jpg,png
                                                <input type="file" name="berkas" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label for="inputText3" class="col-form-label">Nama Pemesan</label>
                                                <input id="inputText3" type="text" name="nama" class="form-control" placeholder="Ahmad Dewa">
                                            </div>
                                           <div class="form-group">
                                                <label for="inputText5" class="col-form-label">Nomor Handphone</label>
                                                <input id="inputText5" type="number" name="no_hp" class="form-control" placeholder="081251313243">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label for="inputPassword">Alamat Pemesan</label>
                                                <textarea class="form-control" name="alamat_penyewa" placeholder="Jl Pabrik Es Kasri"></textarea>
                                            </div>
                                            <div class="form-group">
                                                <label for="inputPassword">Mobil</label>
                                                <input id="inputPassword" type="text" placeholder="Avanza" name="mobil" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label for="inputPassword">Perjalanan</label>
                                                <input id="inputPassword" type="text" placeholder="Malang - Denpasar" name="perjalanan" class="form-control">
                                            </div>
                                             <div class="form-group">
                                                <label for="inputPassword">Jenis Bayar</label>
                                             ...
                                             <div class="form-group">
                                                ...
                                                <input id="inputPassword" type="text" placeholder="200000 24x1jam" name="harga" class="form-control">
                                            </div>
                                             <div class="form-group">
                                                <label for="inputPassword">Tgl Pinjam</label>
                                                <input id="inputPassword" type="date" placeholder="20/05/2019" name="tgl_pinjam" class="form-control">
                                            </div>
                                             <div class="form-group">
                                                <label for="inputPassword">Tgl Kembali</label>
                                                <input id="inputPassword" type="date" placeholder="21/05/2019" name="tgl_kembali" class="form-control">
                                            </div>
                                            <div class="form-group">
