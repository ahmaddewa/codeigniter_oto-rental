                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <?php extract($penyewas); ?>
                                        <form action="<?php echo base_url(); ?>pegawai/u_penyewa/<?php echo $id_penyewa; ?>" method="post">
                                           ...
                                           <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label for="inputPassword">Alamat Penyewa</label>
                                                <input id="inputPassword" type="text" value="<?php echo $alamat_penyewa; ?>" name="alamat penyewa" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label for="inputPassword">Mobil</label>
                                                <input id="inputPassword" type="text" value="<?php echo $mobil; ?>" name="mobil" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label for="inputPassword">Perjalanan</label>
                                                <input id="inputPassword" type="text" value="<?php echo $perjalanan; ?>" name="perjalanan" class="form-control">
                                            </div>
                                             <div class="form-group">
                                                <label for="inputText4" class="col-form-label">Jenis Kelamin</label>
                                                <select class="form-control" name="jenis_bayar">
                                                    <option value="<?php echo $jenis_bayar; ?>"><?php echo $jenis_bayar; ?></option>
                                             ...
                                             <div class="form-group">
                                                ...
                                                <input id="inputPassword" type="text" value="<?php echo $harga; ?>" name="harga" class="form-control">
                                            </div>
                                             <div class="form-group">
                                                <label for="inputPassword">Tgl Pinjam</label>
                                                <input id="inputPassword" type="date" value="<?php echo $tgl_pinjam; ?>" name="tgl_pinjam" class="form-control">
                                            </div>
                                             <div class="form-group">
                                                <label for="inputPassword">Tgl Kembali</label>
                                                <input id="inputPassword" type="date" value="<?php echo $tgl_kembali; ?>" name="tgl_kembali" class="form-control">
                                            </div>
                                            <div class="form-group">
