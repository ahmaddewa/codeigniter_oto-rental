                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form action="<?php echo base_url(); ?>pegawai/t_pegawai" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="inputText3" type="text" name="username" class="form-control" placeholder="ahmaddewa">
                                            </div>
                                            <div class="form-group">
                                                <label for="inputText3" class="col-form-label">Password</label>
                                                <input id="inputText3" type="password" name="password" class="form-control" >
                                            </div>
                                            <div class="form-group">
                                                <label for="inputText3" class="col-form-label">Email</label>
                                                <input id="inputText3" type="email" name="email" class="form-control" placeholder="xxxx@otorental.com">
                                            </div>
