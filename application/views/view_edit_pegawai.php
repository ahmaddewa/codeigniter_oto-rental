                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <?php extract($pegawais); ?>
                                        <form action="<?php echo base_url(); ?>pegawai/u_pegawai/<?php echo $id_pegawai; ?>" method="post">
                                            <div class="form-group">
                                                <label for="inputText3" class="col-form-label">Username</label>
                                                <input id="inputText3" type="text" name="nama_mobil" class="form-control" value="<?php echo $username; ?>" placeholder="Taruna">
                                            </div>
                                           <div class="form-group">
                                                <label for="inputText5" class="col-form-label">Nama</label>
                                                <input id="inputText5" type="text" name="nopol" class="form-control" value="<?php echo $nama; ?>" placeholder="N 1678 SU">
                                            </div>
                                            <div class="form-group">
                                                <label for="inputText4" class="col-form-label">Email</label>
                                                <input id="inputText4" type="text" name="warna" class="form-control" value="<?php echo $email; ?>" placeholder="Silver">
                                            </div>
