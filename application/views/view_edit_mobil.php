                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <?php extract($mobils); ?>
                                        <form action="<?php echo base_url(); ?>pegawai/update/<?php echo $id; ?>" method="post">
                                            <div class="form-group">
                                                <label for="inputText3" class="col-form-label">Nama Mobil</label>
                                                <input id="inputText3" type="text" name="nama_mobil" class="form-control" value="<?php echo $nama_mobil; ?>" placeholder="Taruna">
                                            </div>
                                           <div class="form-group">
                                                <label for="inputText5" class="col-form-label">Nomor Polisi</label>
                                                <input id="inputText5" type="text" name="nopol" class="form-control" value="<?php echo $nopol; ?>" placeholder="N 1678 SU">
                                            </div>
                                            <div class="form-group">
                                                <label for="inputText4" class="col-form-label">Warna</label>
                                                <input id="inputText4" type="text" name="warna" class="form-control" value="<?php echo $warna; ?>" placeholder="Silver">
                                            </div>
                                            <div class="form-group">
                                                <label for="inputPassword">Jumlah Kursi</label>
                                                <input id="inputPassword" type="number" placeholder="7" value="<?php echo $jumlah_kursi; ?>" name="jumlah_kursi" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label for="inputPassword">Tahun</label>
                                                <input id="inputPassword" type="number" placeholder="2021" value="<?php echo $tahun; ?>" name="tahun" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label for="inputPassword">Merk</label>
                                                <input id="inputPassword" type="text" placeholder="Daihatsu" value="<?php echo $merk; ?>" name="merk" class="form-control">
                                            </div>
                                            <div class="form-group">
