...
echo $query->num_rows(); ?></h1>
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="card">
                                    <h5 class="card-header">Tambah Supir </h5>
                                    <div class="card-body">
                                        <form action="<?php echo base_url(); ?>pegawai/t_supir" method="post" enctype="multipart/form-data">
                                            <div class="form-group">
                                                <label for="inputText3" class="col-form-label">Upload Foto Supir</label> <br>
                                                max 100kb. allow gif,jpg,png
                                                <input type="file" name="berkas" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label for="inputText3" class="col-form-label">Nama Supir</label>
                                                <input id="inputText3" type="text" name="nama" class="form-control" placeholder="Taruna">
                                            </div>
                                           <div class="form-group">
                                                <label for="inputText5" class="col-form-label">Nomor Handphone</label>
                                                <input id="inputText5" type="number" name="no_hp" class="form-control" placeholder="0812038123">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="inputPassword" type="text" placeholder="15 Tahun" name="pengalaman" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label for="inputPassword">Nomor KTP</label>
                                                <input id="inputPassword" type="number" placeholder="35010101xxxx" name="no_ktp" class="form-control">
                                            </div>
                                            <div class="form-group">
